...
<div class="js-signup-modal class_55 hide" >
	...
	<form onsubmit="signup.submit(event)" method="post" class="class_57" >
		<div class="class_30" >
			<div class="class_58" >
				<label class="class_32"  for="username">
					Username:
				</label>
				<input placeholder="Username" type="text" name="username" class="class_33"  required="true" autocomplete="username" id="username">
			</div>
			<div class="class_58" >
				<label class="class_32"  for="email">
					Email:
				</label>
				<input placeholder="Email" type="email" name="email" class="class_33"  required="true" autocomplete="email" id="email">
			</div>
			<div class="class_58" >
				<label class="class_32"  for="password">
					Password:
				</label>
				<input placeholder="Password" type="password" name="password" class="class_33" required="true" id="password">
			</div>
			<div class="class_58" >
				<label class="class_36" for="retype_password" >
					Retype Password:
				</label>
				<input placeholder="Retype Password" type="password" name="retype_password" class="class_33" required="true" id="retype_password">
			</div>
