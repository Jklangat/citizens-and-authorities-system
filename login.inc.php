	...
	<form onsubmit="login.submit(event)" method="post" class="class_57" >
		<div class="class_30" >
			<div class="class_58" >
				...
				<input placeholder="Email" type="email" name="email" class="class_33"  required="true"  autocomplete="email">
			</div>
			<div class="class_58" >
				<label class="class_32" for="password" >
					Password:
				</label>
				<input placeholder="Password" type="password" name="password" class="class_33" required="true" autocomplete="current-password">
			</div>
