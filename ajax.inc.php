	...
	if ($_POST['data_type'] == 'login') {
		...
		if (!$row) {
			...
			if (password_verify($_POST['password'], $row['password'])) {
				...
				if (strpos($email, '@kabarak.ac.ke') !== false) {
					$_SESSION['USER']['role'] = 'authority';
				} else {
					$_SESSION['USER']['role'] = 'citizen';
				}
				...
				$info['redirect'] = ($_SESSION['USER']['role'] === 'authority') ? 'Authorities section.php' : 'Citizen section.php';
			} else {
				// Incorrect password
				$info['success'] = false;
				$info['message'] = "Wrong email or password";
